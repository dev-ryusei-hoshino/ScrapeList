/*
 * AlightMotion Premium Generator V5
 *
 * Author: Ryusei Hoshino (https://github.com/dev-ryusei-hoshino)
 * Base: https://ampremnyxie.vercel.app/
...
async function sendLink(email) {
  const res = await fetch("https://ampremnyxie.vercel.app/api/send", {
    method: "POST",
    headers: {
...
async function verifyLink(email, link) {
  const res = await fetch("https://ampremnyxie.vercel.app/api/verify", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
      Accept: "application/json",
